module github.com/ccfish2/infra

go 1.26.0

require (
	github.com/blang/semver/v4 v4.0.0
	github.com/ccfish2/metalb0110 v0.0.0-20250321174246-23e019406889
	github.com/cilium/deepequal-gen v0.0.0-20260817061921-e5a8128944c9
