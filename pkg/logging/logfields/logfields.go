...
const (
	...
	// V4HealthIP is an address used to contact the dolphin-health endpoint
	V4HealthIP = "v4healthIP.IPv4"

	// V6HealthIP is an address used to contact the dolphin-health endpoint
	V6HealthIP = "v6healthIP.IPv6"

	// V4IngressIP is an address used to contact the dolphin-Ingress endpoint
	V4IngressIP = "v4IngressIP.IPv4"

	// V6IngressIP is an address used to contact the dolphin-Ingress endpoint
	...
	// dolphinNetworkPolicy is a dolphin specific NetworkPolicy
	dolphinNetworkPolicy = "dolphinNetworkPolicy"

	// dolphinNetworkPolicyName is the name of a dolphinNetworkPolicy
	dolphinNetworkPolicyName = "dolphinNetworkPolicyName"

	// dolphinClusterwideNetworkPolicyName is the name of the dolphinClusterWideNetworkPolicy
	dolphinClusterwideNetworkPolicyName = "dolphinClusterwideNetworkPolicyName"

	// BPFClockSource denotes the internal clock source (ktime vs jiffies)
	BPFClockSource = "bpfClockSource"

	// dolphinLocalRedirectPolicyName is the name of a dolphinLocalRedirectPolicy
	dolphinLocalRedirectName = "dolphinLocalRedirectPolicyName"

	// dolphinEgressGatewayPolicyName is the name of a dolphinEgressGatewayPolicy
	dolphinEgressGatewayPolicyName = "dolphinEgressGatewayPolicyName"

	// dolphinClusterwideEnvoyConfigName is the name of a dolphinClusterwideEnvoyConfig
	dolphinClusterwideEnvoyConfigName = "dolphinClusterwideEnvoyConfigName"

	// dolphinEnvoyConfigName is the name of a dolphinEnvoyConfig
	dolphinEnvoyConfigName = "dolphinEnvoyConfigName"
	...
	// K8sEndpointName is the k8s name for a k8s Endpoint (not a dolphin Endpoint)
	...
	// K8sNetworkPolicy is a k8s NetworkPolicy object (not a dolphinNetworkObject, above).
	...
	// CEPName is the name of the dolphinEndpoint.
	CEPName = "dolphinEndpointName"

	// CEPCount is the count of the dolphinEndpoint.
	CEPCount = "dolphinEndpointCount"

	// CEPUID is the UID of the dolphinEndpoint.
	CEPUID = "dolphinEndpointUID"

	// CIDName is the name of the dolphinIdentity.
	CIDName = "dolphinIdentityName"

	// CESName is the name of the dolphinEndpointSlice.
	CESName = "dolphinEndpointSliceName"
	...
	// CIDRGroupRef is a references to a dolphinCIDRGroup object.
	...
	RemovedolphinNodeTaintsFlagOption = "remove-dolphin-node-taints"

	SetdolphinNodeTaintsFlagOption = "set-dolphin-node-taints"

	SetdolphinIsUpConditionFlagOption = "set-dolphin-is-up-condition"
	...
	// CESFeatureEnabled indicates whether dolphinEndpointSlice feature is enabled.
